class ListarCursos extends HTMLElement {
    ...
    actualizarCurso = async (id) => {
        const nuevoNombre = prompt("Ingrese el nuevo nombre del curso:");
        const nuevaDuracion = prompt("Ingrese la nueva duración del curso (en horas):");
        const nuevoNivel = prompt("Ingrese el nuevo nivel del curso:");
        if (!nuevoNombre || !nuevaDuracion || !nuevoNivel) {
            ...
            tablaHtml += `
                <tr>
                    ...
                    <td class="botones">
                        ...
                        <button class="boton actualizar" onclick="document.querySelector('listar-cursos').actualizarCurso(${curso.id_curso})">Agregar</button>
                    </td>
                </tr>
            `;
        });
