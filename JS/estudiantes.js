class ListarEstudiantes extends HTMLElement {
    ...
    actualizarEstudiante = (id) => {
        ...
        if (nuevoNombre && nuevoCorreo && nuevoNivel) {
            fetch(`http://localhost:8000/estudiantes/${id}`, {
                method: 'PUT',
                headers: {
            ...
            html += `
                <tr>
                    ...
                    <td class="botones">
                        ...
                        <button class="boton actualizar" onclick="document.querySelector('listar-estudiantes').actualizarEstudiante(${estudiante.id_estudiante})">Agregar</button>
                    </td>
                </tr>
            `;
        });
